...
func TestUserModelGet(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Initialize a connection pool to our test database, and defer a call to the teardown function, so it is always run immediately before this sub-test returns.
